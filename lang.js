  ...
  const pageTranslations = {
    ...
    support: {
      ...
      texts: {
        ...
        '.support-hero p.support-email-text': { ko: '직접 이메일 문의: <a href="mailto:help@shortsmaker.com" style="color:#ff6b00;text-decoration:none;font-weight:bold;">help@shortsmaker.com</a>', en: 'Direct email support: <a href="mailto:help@shortsmaker.com" style="color:#ff6b00;text-decoration:none;font-weight:bold;">help@shortsmaker.com</a>' },
