...
// Handle success redirects from Toss Payments
...
if (urlParams.get("donated") === "true") {
  ...
  const subMsg = getAppLang() === "ko"
    ? "구독이 성공적으로 시작되었습니다! 이제 모든 프리미엄 기능을 마음껏 이용해 보세요. ✨"
    : "Subscription started successfully! Enjoy all premium features. ✨";
  alert(subMsg);
  window.history.replaceState({}, document.title, window.location.pathname);
}
