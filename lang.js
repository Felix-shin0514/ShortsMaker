  ...
  const pageTranslations = {
    ...
    pricing: {
      ...
      texts: {
        ...
        '.plan-card:nth-child(1) h2': { ko: '베이직', en: 'Basic' },
        '.plan-card:nth-child(2) h2': { ko: '프로', en: 'Pro' },
        '.plan-card:nth-child(3) h2': { ko: '크리에이터', en: 'Creator' },
        '.plan-card:nth-child(1) .plan-cta': { ko: '시작하기', en: 'Choose Basic' },
        '.plan-card:nth-child(2) .plan-cta': { ko: '시작하기', en: 'Choose Pro' },
        '.plan-card:nth-child(3) .plan-cta': { ko: '시작하기', en: 'Choose Creator' },
        '.plan-card .plan-note': { ko: '결제 연동 준비중', en: 'Billing setup in progress' }
      }
    },
    support: {
      ...
      texts: {
        ...
        '.support-hero p': { ko: '문의 내용을 남기면 계정 기준으로 접수되고, 관리자 화면에서 확인할 수 있습니다.', en: 'Submit your issue under your account, and the admin can review it from the management panel.' },
