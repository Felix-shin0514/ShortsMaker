try {
  ...
  errDiv.style = "position:fixed;top:0;left:0;width:100%;background:red;color:white;padding:20px;z-index:999999;font-size:20px;font-weight:bold;word-break:break-all;";
  errDiv.textContent = "GLOBAL CRASH: " + (globalErr.stack || globalErr.message);
  if (document.body) document.body.appendChild(errDiv);
  else document.documentElement.appendChild(errDiv);
}
